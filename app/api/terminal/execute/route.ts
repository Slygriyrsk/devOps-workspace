...
Initiating countermeasures...`,
    ...
    // Add these specific git command handlers after the special hacker commands section:

    // Handle git add with better logic
    if (trimmedCommand === "git add" || trimmedCommand === "git add .") {
      try {
        ...
        // Check git status to see what was added
    ...
    // Handle git commit with better logic
